...
//titulo pantalla 1
  ...
  textFont(fuente1);
          ...
          //Acá se puede poner estas dos funciones (mouseX, mouseY) en las coordenadas del título de la película.
          //Si se cambia hace que el título lo puedas mover por toda la pantalla, con solamente mover el mouse.
          
          
//Personajes Principales pantalla2   
      fill(-1);
        fuente2 = loadFont("NSimSun-48.vlw");  
  textFont(fuente2);
        textSize(22);
